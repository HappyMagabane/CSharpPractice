# C# Practice: ContinueStatementSequence
...
C# Practice Exercise for ContinueStatementSequence.
...
```bash
dotnet run --project ContinueStatementSequence/ContinueStatementSequence.csproj
```
