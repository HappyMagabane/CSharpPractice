# C# Practice: DoWhileLoopAverageCalculator
...
C# Practice Exercise for DoWhileLoopAverageCalculator.
...
```bash
dotnet run --project DoWhileLoopAverageCalculator/DoWhileLoopAverageCalculator.csproj
```
