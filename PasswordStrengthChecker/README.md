# C# Practice: PasswordStrengthChecker
...
C# Practice Exercise for PasswordStrengthChecker.
...
```bash
dotnet run --project PasswordStrengthChecker/PasswordStrengthChecker.csproj
```
