# C# Practice: StringConcatenationOperators
...
C# Practice Exercise for StringConcatenationOperators.
...
```bash
dotnet run --project StringConcatenationOperators/StringConcatenationOperators.csproj
```
