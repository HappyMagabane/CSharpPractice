# C# Practice: NullCoalescingOperator
...
C# Practice Exercise for NullCoalescingOperator.
...
```bash
dotnet run --project NullCoalescingOperator/NullCoalescingOperator.csproj
```
